...
let app = document.getElementById("studyArea");
...
"🔥 Keep going! You are studying with others!";
...
let name=
localStorage.getItem("aimersName")
||"Student";
...
if(badgeBox && typeof xp!="undefined"){


if(xp>=1000){

badgeBox.innerHTML +=
"<span>🔥 Study Warrior</span>";
...
let area=document.querySelector(".dashboard");
